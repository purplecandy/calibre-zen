...
assert not is_running_from_develop, 'develop mode is still on: the bundle would rebuild itself at launch'
assert calibre.__file__.startswith('$C/Resources/src/'), calibre.__file__
